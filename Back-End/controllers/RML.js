...
const RML = (req,res) =>{
    ...
    exec(`sh /home/ebossteam/RML/ojjo/excecuteme.sh >> /home/ebossteam/RML/ojjo/salidadelnode.txt ${checkcontroller.ip} ${checkcontroller.usr} ${checkcontroller.pass} `, (error, stdout, stderr) => {
        if (error) {
