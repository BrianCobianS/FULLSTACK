...
contenido.insert(4,"ansible-playbook /home/ebossteam/ansibletest/ansible/playbooks/os4690/Install_Controller.yml -vv  -i /home/ebossteam/ansibletest/ansible/Inventories/import_inventory.yml -e 'level_complement="+COMP+" opc="+OPC+" ASM="+ASM+" level_name="+LEV+"' 2>&1 | tee /var/log/logscontroladores/"+IP+"-$(date +%Y%m%d_%H%M%S).txt")
